...
export class 查询 {
  ...
  @Column({ name: 'WanGongenddime', nullable: true, type: 'datetime' })
  wanGongenddime?: Date | null;

  @Column({ name: 'weihufei', length: 20, nullable: true, type: 'varchar' })
  weihufei?: string | null;

  @Column({ name: 'weihuStarttime', nullable: true, type: 'datetime' })
  weihuStarttime?: Date | null;

  @Column({ name: 'weihuEndtime', nullable: true, type: 'datetime' })
