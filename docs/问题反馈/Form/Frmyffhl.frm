...
Private Sub cmd1_Click(Index As Integer)
    ...
    Case 0
        ...
        '        End If
        objFormSetting.FillList Me.lst1, "select * from FN_yw_kehuxinxi3 ('" & DTPicker1(0).Value & "','" & DTPicker1(1).Value & "') "
    Case 2
    End Select
End Sub
