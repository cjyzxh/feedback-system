...
Begin VB.Form Frmyfzzltjb 
   ...
   Begin UserControl.lst lst1 
      ...
      BackColorSel    =   49152
      RowHeightMin    =   300
      ColumnCaptions  =   "人员;一般;急;紧急;制定;超出"
      ColWidths       =   ""
      ColumnName      =   "人员;一般;急;紧急;制定;超出"
   End
...
Private Sub cmd1_Click(Index As Integer)
    ...
    Case 0
        ...
        '        End If
        objFormSetting.FillList Me.lst1, "select * from FN_yw_kehuxinxi2 ('" & DTPicker1(0).Value & "','" & DTPicker1(1).Value & "') "
    Case 2
    End Select
End Sub
