...
Begin VB.Form frmdaitaolunwt 
   ...
   Begin VB.PictureBox Command1 
      ...
      Height          =   405
      Left            =   13260
      Picture         =   "frmdaitaolunwt.frx":0000
      ScaleHeight     =   405
      ScaleWidth      =   1230
      TabIndex        =   52
      Top             =   4455
   ...
   Begin VB.PictureBox cmdtuichu 
      ...
      Height          =   405
      Left            =   10605
      Picture         =   "frmdaitaolunwt.frx":0B7B
      ScaleHeight     =   405
      ScaleWidth      =   1230
      TabIndex        =   51
      Top             =   4455
   ...
   Begin VB.PictureBox Command3 
      ...
      Height          =   405
      Left            =   9255
      Picture         =   "frmdaitaolunwt.frx":146E
      ScaleHeight     =   405
      ScaleWidth      =   1230
      TabIndex        =   50
      Top             =   4455
   ...
   Begin VB.PictureBox Command2 
      ...
      Height          =   405
      Left            =   11940
      Picture         =   "frmdaitaolunwt.frx":202C
      ScaleHeight     =   405
      ScaleWidth      =   1230
      TabIndex        =   49
      Top             =   4455
   ...
   Begin VB.PictureBox cmddaying 
      ...
      Height          =   405
      Left            =   7875
      Picture         =   "frmdaitaolunwt.frx":298E
      ScaleHeight     =   405
      ScaleWidth      =   1230
      TabIndex        =   48
      Top             =   4455
   ...
   Begin VB.PictureBox cmdchaxun 
      ...
      Height          =   405
      Left            =   6510
      Picture         =   "frmdaitaolunwt.frx":357B
      ScaleHeight     =   405
      ScaleWidth      =   1230
      TabIndex        =   47
      Top             =   4440
   ...
   Begin VB.PictureBox cmdqingkong 
      ...
      Height          =   405
      Left            =   5160
      Picture         =   "frmdaitaolunwt.frx":3EC5
      ScaleHeight     =   405
      ScaleWidth      =   1230
      TabIndex        =   46
      Top             =   4455
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.ComboBox cbojingjicd 
         ForeColor       =   &H00FF0000&
         Height          =   300
         ItemData        =   "frmdaitaolunwt.frx":47D4
         Left            =   1530
         List            =   "frmdaitaolunwt.frx":47E1
         TabIndex        =   21
         Top             =   765
         Width           =   1500
      End
      Begin VB.ComboBox cbogongcs 
         Height          =   300
         ItemData        =   "frmdaitaolunwt.frx":47F5
         Left            =   1545
         List            =   "frmdaitaolunwt.frx":47F7
         TabIndex        =   20
         Top             =   240
         Width           =   1335
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cbowentilx 
         ForeColor       =   &H00C00000&
         Height          =   300
         ItemData        =   "frmdaitaolunwt.frx":47F9
         Left            =   1080
         List            =   "frmdaitaolunwt.frx":480F
         TabIndex        =   6
         Top             =   720
         Width           =   1215
      End
      ...
      Begin VB.ComboBox cbobanben 
         Appearance      =   0  'Flat
         Height          =   300
         ItemData        =   "frmdaitaolunwt.frx":4859
         Left            =   1080
         List            =   "frmdaitaolunwt.frx":486C
         TabIndex        =   1
         Top             =   240
         Width           =   1215
      End
   ...
   Begin VB.Image Image2 
      ...
      Index           =   4
      Left            =   240
      Picture         =   "frmdaitaolunwt.frx":48A3
      Top             =   10035
      Width           =   450
   End
   Begin VB.Image Image2 
      ...
      Index           =   3
      Left            =   240
      Picture         =   "frmdaitaolunwt.frx":4D97
      Top             =   8100
      Width           =   450
   End
   Begin VB.Image Image2 
      ...
      Index           =   2
      Left            =   240
      Picture         =   "frmdaitaolunwt.frx":528B
      Top             =   6360
      Width           =   450
   End
   Begin VB.Image Image2 
      ...
      Index           =   1
      Left            =   240
      Picture         =   "frmdaitaolunwt.frx":577F
      Top             =   4260
      Width           =   450
   End
   ...
   Begin VB.Image Image2 
      ...
      Index           =   0
      Left            =   300
      Picture         =   "frmdaitaolunwt.frx":5C73
      Top             =   300
      Width           =   450
   End
   ...
   End
End
Attribute VB_Name = "frmdaitaolunwt"
...
msfwentilb.Clear
    ...
    '根据不同情况选择查询时间的种类
str1 = "select lsh AS '流水号',banben as '版本', yiyuanmc as '医院名称', szcsgcs as '问题反馈人', mokuai as '模块', chuangtimc as '窗体',wentism as '问题说明',shouzhongcs as '售中测试说明',gongcscs as '工程师说明',shouhoucs as '售后测试',lvrusj as '问题录入时间',xgsj as '修改时间',xggcs as '修改工程师',wentilx as '问题类型' " & Chr(13) _
& "from yw_wentilb where (taolunsj between '" & Format(dtpkssj.Value, "yyyy-mm-dd") & " 00:00:01' and '" & Format(dtpjssj.Value, "yyyy-mm-dd") & " 23:59:59') and taolunbz='是'"
...
msfwentilb.Clear
    ...
    '根据不同情况选择查询时间的种类
str1 = "select lsh AS '流水号',banben as '版本', yiyuanmc as '医院名称', szcsgcs as '问题反馈人', mokuai as '模块', chuangtimc as '窗体',wentism as '问题说明',shouzhongcs as '售中测试说明',gongcscs as '工程师说明',shouhoucs as '售后测试',lvrusj as '问题录入时间',xgsj as '修改时间',xggcs as '修改工程师',wentilx as '问题类型' from yw_wentilb where (taolunsj between '" & Format(dtpkssj.Value, "yyyy-mm-dd") & " 00:00:01' and '" & Format(dtpjssj.Value, "yyyy-mm-dd") & " 23:59:59') and taolunbz='是'"
...
If MsgBox("确定要返回所选的问题吗？", vbYesNo + vbQuestion, "提示") = vbYes And msfwentilb.TextMatrix(msfwentilb.row, 0) <> "" Then
    str = "update yw_wentilb set taolunbz='否',gongchengsbz='否' where lsh='" & Trim(msfwentilb.TextMatrix(msfwentilb.row, 0)) & "' "
    Set Rs = conn.Execute(str)
    MsgBox "问题已成功返回待处理状态，请通知工程师修改！", vbOKOnly + vbInformation, "提示"
    msfwentilb.RemoveItem msfwentilb.row
Else
    Exit Sub
End If
End Sub
...
Rs.Close
'加载售中售后人员
    str = "select * from [user] where quxian='测试员'"
    Rs.CursorLocation = adUseClient
     Rs.Open str, conn
    If Not Rs.EOF Then
